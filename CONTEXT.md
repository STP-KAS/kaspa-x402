...
The capital-backed `kaspa-escrow-v3` mechanism for repeated small or
fixed-price requests. The buyer signs lifetime cumulative voucher ceilings;
...
current covenant value, and R for the advertised minimum successor reserve. Durable runtimes
