...
Status: current release-candidate closure notes after narrowing the shipped native surface.
...
| ------------------------------------------------------------------------------------- | ----------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Public surface must only advertise implemented native profiles                        | Fixed for current release candidate                   | Schemas, package types, examples, specs, vectors, and runtime offer selection accept only `exact` and `batch-settlement`.                                                                                                                                                                                                                                                                          |
| Batch covenant authority must be reproducible                                         | Fixed for v1 RC1 source; mainnet audit still required | Escrow fixture checks and transaction-v1 vectors cover singleton genesis, two partial claims against one voucher, same-ID top-up, and timeout refund. The batch interop vector preserves one stable covenant ID and reconciles A/S/T/V/R with the transaction sequence.                                                                                                                             |
...
| Live proof harness must be reproducible from committed code                           | Proven for v1 RC1 on funded TN10                    | The proof runner and reference adapter reproduced all 18 required v1 RC1 flows in the 2026-09-10 funded TN10 run, including exact settlement and recovery, additive conflict handling, singleton batch genesis, stable-ID vouchers, repeated partial claims, provider-authorized top-up, stale-head rejection, terminal refund, and restart reload. Sanitized evidence is in `docs/live-testnet-report.md`; secrets and raw operational artifacts remain ignored. |
...
## v1 RC1 Fresh Security Diff Review

The executed security diff review reported nine findings. v1 RC1 closes the six
